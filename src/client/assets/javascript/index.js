...
async function handleCreateRace() {
	try {
		// Getting plyer_id & track_id from store object
		...
		if(!player_id){
			...
			alert("You have not selected any game track");
		} else{					
			...
			// calling the async function runCountdown
			await runCountdown();
